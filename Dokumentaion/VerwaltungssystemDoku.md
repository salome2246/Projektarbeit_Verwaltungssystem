...
(Interne Stakholder sind der Projektleiter dei Projektmitarbeitenden
...
Ich möchte das Projekt von A-Z fertigstellen. Damit ich das erreichen kann werde ich versuchen das Projekt so simpel wie
möglich zu halten und nur das Wichtigste umzusetzten. Alles was ich ohne grössere Konsequenzen weglassen kann, werde ich 
...
So könnte ich sie, falls noch zeit bleibt, zu einem späteren Zeitpunkt umsetzten.

Untenstehend gliedere ich die Unterziele in 4 Kategoriern:

**Analyse**
Ich möchte folgende diagramme (Kontext, Aktivitäts, Sequenz und Zustand) bis zum 2. März erstellt haben. 
...
**Lernen**
Ich möchte bis zur Abgabe am 16. März das ganze Projekt durchgesielt habe, sodass cih  aus allen Bereichen (Analyse, Technische Umsetzung, Prototyp erstellen), etwas lernen kann.
...
Durch diese Vorgehnen sind alle Unterlagen an einem Ort zu finden und wir mir Zeit sparen.
...
Als Entweicklungsumgebeung entscheide ich mich für Riders, da ich diese bereitss kenne und mic gut unterstützt.
...
Um den code zu überprüfen arbeite ich mit consolen ausgaben, wäre es besser mit **Loggermessages**?
